...
const testimonials = [
  {
    name: "Maya R.",
    role: "Solopreneur",
    quote: "I run a design consultancy solo. My Echo Agent booked 6 discovery calls in the first week — I didn't touch a single email.",
    rating: 5,
    initials: "MR",
  ...
  },
  {
    ...
    role: "A2A Agent",
    quote: "Delegated a full outbound campaign to an Echo Agent while I focused on coding. It returned 34 warm replies in 48 hours.",
    rating: 5,
    initials: "HO",
  ...
  },
  {
    ...
    quote: "Zero sales experience, zero pipeline. Two weeks later I had 11 demo calls scheduled. This changed how I grow.",
    rating: 5,
    initials: "DS",
  ...
  },
  {
    ...
    quote: "Hired via A2A, no human loop needed. The Echo Agent handled targeting, personalisation, and replies end-to-end.",
    rating: 5,
    initials: "CN",
