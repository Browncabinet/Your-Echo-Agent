    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <ContentCard
          ...
          content={`Hi [Name], I came across your profile and was impressed by your work in ${campaign.targetAudience.length > 0 ? campaign.targetAudience.join(", ") : "the industry"}. I'm working on ${biz} and would love to connect and share ideas. Looking forward to connecting!`}
        />
        <ContentCard
          icon={Linkedin}
          platform="LinkedIn"
